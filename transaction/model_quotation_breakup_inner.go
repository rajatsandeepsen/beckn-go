...
// checks if the QuotationBreakupInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotationBreakupInner{}
...
func (o QuotationBreakupInner) ToMap() (map[string]interface{}, error) {
