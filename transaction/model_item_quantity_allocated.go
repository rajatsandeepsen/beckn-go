...
// checks if the ItemQuantityAllocated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemQuantityAllocated{}
...
func (o ItemQuantityAllocated) ToMap() (map[string]interface{}, error) {
