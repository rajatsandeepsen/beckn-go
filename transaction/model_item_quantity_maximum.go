...
// checks if the ItemQuantityMaximum type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemQuantityMaximum{}
...
func (o ItemQuantityMaximum) ToMap() (map[string]interface{}, error) {
