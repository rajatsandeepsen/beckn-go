...
// APIClient manages communication with the Beckn Protocol Registry Infrastructure API API v1.1.1
...
type APIClient struct {
	...
	SubscriberBAPBPPBGAPI *SubscriberBAPBPPBGAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SubscriberBAPBPPBGAPI = (*SubscriberBAPBPPBGAPIService)(&c.common)
